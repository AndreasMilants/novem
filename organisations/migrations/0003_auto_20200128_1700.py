...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('organisations', '0002_auto_20200126_1153'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, unique=True, verbose_name='organisation'),
        ),
        migrations.AlterField(
